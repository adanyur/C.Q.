...
class ParticipantesModel(models.Model):
    ...
    cq_codpar	= models.CharField(primary_key=True,max_length=3)
...
class TipoParticipanteModel(models.Model):
    ...
    cq_usuario= models.CharField(max_length=15)
    cq_fecpro = models.DateTimeField()
    # cq_codpar = models.ForeignKey(ParticipantesModel,related_name='descripcion',on_delete=models.CASCADE,db_column='cq_codpar')
